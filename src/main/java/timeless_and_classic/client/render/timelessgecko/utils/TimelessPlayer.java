package timeless_and_classic.client.render.timelessgecko.utils;

import net.minecraft.client.renderer.entity.model.PlayerModel;
import net.minecraft.client.renderer.model.ModelRenderer;

public enum TimelessPlayer {
/*
    HEAD("head"),
    HEAD_WEAR("head_wear"),
    CHEST("chest"),
    ...
    public void setVisibility(PlayerModel model, boolean visible) {
        ...
        if (modelRenderer == null) {
            ...
            modelRenderer.showModel = visible;
        }
        return;
    }
    ...
    public static TimelessPlayer getByName(String name) {
        for (TimelessPlayer playerPart : values()) {
