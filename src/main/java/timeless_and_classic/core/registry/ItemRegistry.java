...
import timeless_and_classic.core.types.AutomaticTimelessGunItem;
import timeless_and_classic.core.types.TimelessAmmoItem;
import timeless_and_classic.core.types.TimelessGunItem;


import static timeless_and_classic.core.TimelessConfig.COMMON;
import static timeless_and_classic.core.timeless_and_classic.*;
...
public class ItemRegistry {
    ...
    public static final RegistryObject<TimelessGunItem> M4 = ITEM_REGISTRY.register("m4", () -> new AutomaticTimelessGunItem(properties -> properties.group(MODERN_GROUP), COMMON.AR15P_trigMax));
